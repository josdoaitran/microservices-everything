...
- Serverless-test-and-Bebug: https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-test-and-debug.html
...
- AWS Lambda Handle CookBook: https://github.com/ran-isenberg/aws-lambda-handler-cookbook
